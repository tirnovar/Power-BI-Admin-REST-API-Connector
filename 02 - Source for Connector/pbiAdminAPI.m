            ...
            objects =
                #table(
                    ...
                    },
                    {
                        ...
                        {
                            Extension.LoadString("AppsUsers"),
                            "AppsUsers",
...
ScannerAPIInfo =
    (optional workspaceId as text, optional listWithWokspaceIds as list) =>
        let
            functionVarTester =
                if
                    (
